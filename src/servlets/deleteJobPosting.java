...
public class deleteJobPosting extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int rs = st.executeUpdate("DELETE FROM job_list where code = '" + code + "' and title = '" + title + "'");

            if (rs == 0) {
                out.println("Error: Couldn't delete the selected user.");
            } else {
            ...
            Logger.getLogger(deleteJobPosting.class.getName()).log(Level.SEVERE, null, ex);

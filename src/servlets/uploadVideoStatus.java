 ...
 * @author tanuj_000
 */
public class uploadVideoStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int rs = st.executeUpdate("UPDATE user_list set videostatus = '" + videostatus + "' WHERE name = '" + name + "' AND id = '" + id + "'");

            if (rs == 1) {
                out.println("Video Status edited successfully!");
            } else {
                out.println("Error : Video Status update failed.");
            }
            st.close();
            co.close();
            ...
            Logger.getLogger(uploadVideoStatus.class.getName()).log(Level.SEVERE, null, ex);

<%-- 
    Document   : Demo_Silver_Quarterly
    Created on : 27 Aug, 2015, 1:51:28 PM
    Author     : tanuj_000
--%>
...
<html>
    ...
    <head>
        ...
        <meta charset="UTF-8">
        <title>REDHOLT | ORACLE Quarterly Report</title>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            <%=username%> - REDHOLT
                                            <small>ORACLE Quarterly (Silver)</small>
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
            ...
            <div class="content-wrapper"  style="background-color: #f2f2f2">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"> ORACLE - Quarterly</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <h3 style="font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif">
                               ORACLE Tracker
                                ...
                                &nbsp;
                                <img src="dist/img/silverIcon.png" data-original-title="Silver - Quarterly" data-toggle="tooltip" style="padding-bottom: 0.2%"/>
                            </h3>
                            <br>
                        </div>
                        ...
                        <section class="col-lg-6 connectedSortable">
                            <div class="box box-default box-solid" style="border: solid #243038">
                                <div class="box-header" style="background-color: #243038; color: #EEEEEE"><!--  style="background-color: #434b56" -->
                                    <icon class="fa fa-bar-chart"></icon>
                                    <h3 class="box-title"><b>Quarterly Hires</b>
                                    </h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus" style="color: #EEEEEE"></i></button>
                                    </div>
                                ...
                                <div class="box-body no-padding">
                                    ...
                                    <div class="col-lg-12" align="center">
                                        <div class="col-lg-12">
                                            <div id="QuarterlyHiresChart" style="width: 100%; height: 400px; background-color: #FFFFFF;" ></div>
                                        </div><!-- /.col-lg-12 -->
                                        <div class="col-lg-12" id="QuarterlyHiresTableDiv">
                                            <br><br><br><br>
                                            <table id="QuarterlyHiresTable" class="table table-bordered table-hover" style="background-color: #FFFFFF">
                                            </table>
                                            <br>
                                        </div><!-- /.col-lg-12 -->
                                    </div>
                        ...
                        <section class="col-lg-6 connectedSortable">
                            <div class="box box-default box-solid" style="border: solid #243038">
                                <div class="box-header" style="background-color: #243038; color: #EEEEEE"><!--  style="background-color: #434b56" -->
                                    <icon class="fa fa-bar-chart"></icon>
                                    <h3 class="box-title"><b>Quarterly Source Of Hires</b>
                                    </h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus" style="color: #EEEEEE"></i></button>
                                    </div>
                                ...
                                <div class="box-body no-padding">
                                    ...
                                    <div class="col-lg-12" align="center">
                                        <div class="col-lg-12">
                                            <div id="QuarterlySourceOfHiresChart" style="width: 100%; height: 400px; background-color: #FFFFFF;" ></div>
                                        </div><!-- /.col-lg-12 -->
                                        <div class="col-lg-12" id="QuarterlySourceOfHiresTableDiv">
                                            <br><br><br><br>
                                            <table id="QuarterlySourceOfHiresTable" class="table table-bordered table-hover" style="background-color: #FFFFFF">
                                            </table>
                                            <br>
                                        </div><!-- /.col-lg-12 -->
                                    </div>
                        ...
                        <section class="col-lg-12 connectedSortable">
                            ...
                            <div class="box box-default box-solid" style="border: solid #243038">
                                <div class="box-header" style="background-color: #243038; color: #EEEEEE"><!--  style="background-color: #434b56" -->
                                    ...
                                    <h3 class="box-title"><b>YTD Cancellations</b></h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus" style="color: #EEEEEE"></i></button>
                                    </div>
                                </div><!-- /.box-header -->
...
//To enable 'on click' instead of 'hover'
            ...
            $(document).ready(function () {
                ...
                new Ajax.Request('fetchReportDates', {
                    ...
                    onSuccess: function (transport) {
                        ...
                        new Ajax.Request('getTable_Gold_LexisNexisIndia_QuarterlyHires', {
                            method: 'get',
                            parameters: {quarter: 'Q2', reportdate: '1992-03-20'},
                            onSuccess: function (transport) {
                                var tabledata = transport.responseText;
                                $('#QuarterlyHiresTable').html(tabledata);
                                $('#QuarterlyHiresTable').dataTable({
                                    "bPaginate": false,
                                    "bLengthChange": true,
                                    "bFilter": false,
                                    "bSort": true,
                            ...
                            onFailure: function () {
                                var content = "<b>Snap!</b> Something went wrong while <b>fetching Quarterly Hires Table</b>.";
                                $("#alertModalContent").html(content);
                                $("#alertModal").modal('show');
                            }
                        });
                        ...
                        new Ajax.Request('getTable_Gold_LexisNexisIndia_QuarterlySourceOfHires', {
                            method: 'get',
                            parameters: {reportdate: '1992-03-20', quarter: 'Q2'},
                            onSuccess: function (transport) {
                                var tabledata = transport.responseText;
                                $('#QuarterlySourceOfHiresTable').html(tabledata);
                                $('#QuarterlySourceOfHiresTable').dataTable({
                                    "bPaginate": false,
                                    "bLengthChange": true,
                                    "bFilter": false,
                                    "bSort": true,
                            ...
                            onFailure: function () {
                                var content = "<b>Snap!</b> Something went wrong while <b>fetching Quarterly Source Of Hires Table</b>.";
                                $("#alertModalContent").html(content);
                                $("#alertModal").modal('show');
                            }
                        });
                        new Ajax.Request('getTable_Gold_LexisNexisIndia_Cancellations', {
                            ...
                            onSuccess: function (transport) {
                                var tabledata = transport.responseText;
                                $('#CancellationsTable').html(tabledata);
                            ...
                            onFailure: function () {
                                var content = "<b>Snap!</b> Something went wrong while <b>fetching Quarterly Cancellations Table</b>.";
                                $("#alertModalContent").html(content);
                                $("#alertModal").modal('show');
                            }
                        });
                        ...
                        new Ajax.Request('getData_Gold_LexisNexisIndia_QuarterlyHires', {
                            method: 'get',
                            parameters: {quarter: 'Q2', reportdate: '1992-03-20'},
                            onSuccess: function (transport) {
                                data2 = transport.responseText.evalJSON();
                                datajson2 = JSON.stringify(data2);
                                new Ajax.Request('getGraph_Gold_LexisNexisIndia_QuarterlyHires', {
                                    method: 'get',
                                    parameters: {quarter: 'Q2', reportdate: '1992-03-20'},
                                    onSuccess: function (transport) {
                        ...
                        new Ajax.Request('getData_Gold_LexisNexisIndia_QuarterlySourceOfHires', {
                            method: 'get',
                            parameters: {quarter: 'Q2', reportdate: '1992-03-20'},
                            onSuccess: function (transport) {
                                data4 = transport.responseText.evalJSON();
                                datajson4 = JSON.stringify(data4);
                                new Ajax.Request('getGraph_Gold_LexisNexisIndia_QuarterlySourceOfHires', {
                                    method: 'get',
                                    parameters: {quarter: 'Q2', reportdate: '1992-03-20'},
                                    onSuccess: function (transport) {
                                        graphs4 = transport.responseText.evalJSON();
                                        graphsjson4 = JSON.stringify(graphs4);
                                        QuarterlySourceOfHiresChart();
                                    },
                                    onFailure: function () {
                                        alert('Something went wrong while getting graphs...');
                                    }
                        ...
                        new Ajax.Request('getData_Gold_LexisNexisIndia_CancellationsGraph', {
                            method: 'get',
                            parameters: {reportdate: '1992-03-20'},
                            onSuccess: function (transport) {
                                ...
                                new Ajax.Request('getGraph_Gold_LexisNexisIndia_CancellationsGraph', {
                                    method: 'get',
                                    parameters: {reportdate: '1992-03-20'},
                                    onSuccess: function (transport) {
        ...
        <script type = "text/javascript">
            function QuarterlyHiresChart() {
                chart2 = AmCharts.makeChart("QuarterlyHiresChart",
                        {
                            "type": "serial",
                            "categoryField": "Category",
                            "startDuration": 0,
        ...
        <script type = "text/javascript">
            function QuarterlySourceOfHiresChart() {
                chart4 = AmCharts.makeChart("QuarterlySourceOfHiresChart",
                        {
                            "type": "serial",
                            "categoryField": "Category",
                            "startDuration": 0,
        ...
        <script type = "text/javascript">
            function CancellationsChart() {
                chart5 = AmCharts.makeChart("CancellationsChart",
                        {
                            "type": "serial",
                            "categoryField": "Category",
                            "startDuration": 0,
